...
global.owner = process.env.OWNER_NUMBER  || '2349160836916' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=zIUl0SII#ipRoEaRA9I_vxBTDjILRrjhUPz1cjbwDZNkYA0zK-q8' ,
